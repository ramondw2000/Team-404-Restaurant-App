...
| [NIEUW] | Als manager wil ik toegang hebben tot alle onderdelen van de applicatie, zodat ik volledig beheer heb over het systeem. | Nieuw |
...
| Rol | User Story |
|-----|-----------|
| Manager | Volledige toegang tot de applicatie |
