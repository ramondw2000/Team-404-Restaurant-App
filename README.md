...
- De gebruiker moet een overzicht zien van alle tafels (weergeven in grid formaat?). Hieruit moet de gebruiker de volgende informatie moeten zien:
    - Het tafelnummer.
...
- Alle bestellingen worden verstuurd en aangetoond aan het keukenpersoneel. Per bestelling is er een blokje met daarin de volgende informatie: 
